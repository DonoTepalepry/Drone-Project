...
frameWidth = width
frameHeight = height
# cap = cv2.VideoCapture(1)  ignore this stuff
# cap.set(3, frameWidth)  ignore this stuff
# cap.set(4, frameHeight)  ignore this stuff
# cap.set(10,200)  ignore this stuff
...
cv2.createTrackbar("HUE Min", "HSV", 59, 179, empty) #0
cv2.createTrackbar("HUE Max", "HSV", 179, 179, empty) #0
...
while True:
    ...
    # Geting the frame from the drone
